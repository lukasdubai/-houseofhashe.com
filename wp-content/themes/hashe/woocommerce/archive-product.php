...
img.attachment-shop_catalog.flip-back.size-shop_catalog.flip-back {
    position: absolute !important;
    display: block;
    opacity: 0;
     transition: opacity .5s ease-in-out;
}
img.attachment-shop_catalog.flip-back.size-shop_catalog.flip-back.hovered {
    position: absolute !important;
    display: block;
    opacity: 1;
}
...
jQuery('.flip-back').hover(function() {
